--stream products
CREATE STREAM SOURCE_PRODUCTS WITH (KAFKA_TOPIC='demo.test.store.products', VALUE_FORMAT='AVRO');
-- stream customers
 CREATE STREAM SOURCE_CUSTOMERS WITH (KAFKA_TOPIC='demo.test.store.customers', VALUE_FORMAT='AVRO');
-- stream orders
CREATE STREAM SOURCE_ORDERS WITH (KAFKA_TOPIC='demo.test.store.orders', VALUE_FORMAT='AVRO');
--stream order_items
CREATE STREAM SOURCE_ORDER_ITEMS WITH (KAFKA_TOPIC='demo.test.store.order_items', VALUE_FORMAT='AVRO');
